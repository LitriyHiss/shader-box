...
const bgCol = document.getElementById('contentS');
...
scaleBtn.addEventListener('click', () => {
    ...
    scaleBtn.classList.toggle('select__active');
    colBtn.classList.remove('select__active');
    shadeBtn.classList.remove('select__active');
})
...
colBtn.addEventListener('click', () => {
    ...
    shadow.classList.remove('active');
    scaleBtn.classList.remove('select__active');
    colBtn.classList.toggle('select__active');
    shadeBtn.classList.remove('select__active');
})
...
bgColor.addEventListener('input', () => {
    contentS.style.backgroundColor = `${bgColor.value}`;
})
...
shadeBtn.addEventListener('click', () => {
    ...
    scaleBtn.classList.remove('select__active');
    colBtn.classList.remove('select__active');
    shadeBtn.classList.toggle('select__active');
})
